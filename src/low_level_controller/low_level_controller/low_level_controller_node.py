...
class LowLevelControllerNode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('servo_center', 78)          # degrees (straight)
        self.declare_parameter('servo_min', 33)             # degrees (full right)
        self.declare_parameter('servo_max', 123)            # degrees (full left)
