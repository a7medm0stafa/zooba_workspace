...
class LowLevelControllerNode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('servo_center', 80)          # degrees (straight)
        self.declare_parameter('servo_min', 35)             # degrees (full right)
        self.declare_parameter('servo_max', 125)            # degrees (full left)
